...
{
    #### change your id
    private const CLIENT_ID = '1660786955';
    private const CLIENT_SECRET = 'e2a7c7198c1e9635b50a1e3acfecce0e';
    private const REDIRECT_URL = 'http://localhost/line-login/callback.php';
